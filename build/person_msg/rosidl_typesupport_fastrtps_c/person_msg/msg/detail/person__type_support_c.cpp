...
#include "person_msg/msg/detail/person__rosidl_typesupport_fastrtps_c.h"
...
#include "person_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Person__ros_msg_type = person_msg__msg__Person;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_person_msg
size_t get_serialized_size_person_msg__msg__Person(
  const void * untyped_ros_message,
...
static uint32_t _Person__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_person_msg__msg__Person(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_person_msg
size_t max_serialized_size_person_msg__msg__Person(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Person__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_person_msg__msg__Person(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, person_msg, msg, Person)() {
