...
#include "person_msg/msg/detail/person__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const person_msg::msg::Person *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<person_msg::msg::Person *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_person_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<person_msg::msg::Person>()
{
  return &person_msg::msg::typesupport_fastrtps_cpp::_Person__handle;
}
